...
/**
 * @author palading_cr
 * @title CliviaFileConfigCondition
 * @project clivia
 */
public class CliviaFileConfigCondition implements Condition {

    @Override
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        String conditionType = context.getEnvironment().getProperty(CliviaConstants.gateway_admin_config_type);
        return conditionType.equals(CliviaConstants.gateway_admin_config_type_file);
    }
}
